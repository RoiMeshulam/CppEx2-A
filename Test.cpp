...
TEST_CASE("good easy cases"){
    ...
    CHECK(note.read(0,5,0,Direction::Vertical,5)=="check");
    ...
    CHECK(note.read(0,0,0,Direction::Vertical,10)=="first~~~~~");

}

TEST_CASE("good difficult cases"){
    Notebook note;
    note.write(0,0,0,Direction::Horizontal,"1111");
    note.write(0,0,5,Direction::Horizontal,"2222");
    CHECK(note.read(0,0,0,Direction::Horizontal,9)=="1111_2222");
    note.write(0,1,4,Direction::Vertical,"3333");
    CHECK(note.read(0,0,4,Direction::Vertical,5)=="_3333");
    note.erase(0,0,2,Direction::Horizontal,2);
    note.erase(0,2,4,Direction::Vertical,2);
    CHECK(note.read(0,0,0,Direction::Horizontal,9)=="11~~_2222");
    CHECK(note.read(0,0,4,Direction::Vertical,5)=="_3~~3");
